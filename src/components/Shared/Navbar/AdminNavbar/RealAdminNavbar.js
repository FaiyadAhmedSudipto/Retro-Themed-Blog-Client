            ...
            <nav className="navbar">
                <div className="nav-container">
                    ...
                    <ul className={click ? "nav-menu active" : "nav-menu"}>
                        ...
                        <li class="nav-item">
                            <NavLink exact to="/management" activeClassName="active" className="nav-links" >
                                Blogs Management
                            </NavLink>
                        </li>
                        <li class="nav-item">
                            <NavLink exact to="/addBlogs" activeClassName="active" className="nav-links" >
                                Add New Blogs
                            </NavLink>
                        </li>
                        <li className="nav-item">
...
export default RealAdminNavbar;